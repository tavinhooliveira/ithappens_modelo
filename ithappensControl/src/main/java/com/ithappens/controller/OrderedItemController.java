...
public class OrderedItemController {
	...
	private static final String LIST_ORDEREDITEMS_USER_VIEW = "/pages/ListarOrderedItemsResponsavel";
	...
	// LitasTodasOsPedidosDeUmUsuario
	@RequestMapping(value = "/responsavel/list/{codigo}")
	public ModelAndView listaResposavelOrderedItems(@PathVariable("codigo") User user) {
